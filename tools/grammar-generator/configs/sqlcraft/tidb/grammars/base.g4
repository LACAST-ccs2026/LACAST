...
join_on_clause:table_expr &_FROM_UP  join_type table_expr &_FROM_UP "ON" bool_evaluator_without_sub ;
join_type  : "JOIN"
    | "INNER JOIN"
    | "LEFT JOIN"
    | "RIGHT JOIN"
...
date_AGG_evaluator_default:"CAST(ADDDATE('1970-01-01', COUNT("_var_any")) AS DATE)";
datetime_AGG_evaluator_default:"CAST(DATE_ADD('1970-01-01 00:00:00', INTERVAL COUNT("_var_any") SECOND) AS DATETIME)";
timestamp_AGG_evaluator_default:"FROM_UNIXTIME(COUNT("_var_any"))";
time_AGG_evaluator_default:"SEC_TO_TIME(COUNT("_var_any"))";
year_AGG_evaluator_default:"YEAR(DATE_ADD('1970-01-01', INTERVAL COUNT("_var_any") YEAR))";
