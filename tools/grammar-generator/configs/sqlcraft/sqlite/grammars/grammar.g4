...
integer_evaluator: integer_evaluator_without_agg;
integer_evaluator_without_agg: _var_integer|integer_evaluator_without_agg|_var_integer;
real_evaluator: real_evaluator_without_agg;
real_evaluator_without_agg: _var_real;
numeric_evaluator: numeric_evaluator_without_agg;
numeric_evaluator_without_agg: _var_numeric;
text_evaluator: text_evaluator_without_agg;
text_evaluator_without_agg: _var_text;
blob_evaluator: blob_evaluator_without_agg;
blob_evaluator_without_agg: _var_blob;
