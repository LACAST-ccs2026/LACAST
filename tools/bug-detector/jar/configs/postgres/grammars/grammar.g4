...
integer_evaluator_without_agg:_var_integer|bit_count_bytea_integer_evaluator|bit_length_bytea_integer_evaluator|get_bit_bytea_integer_evaluator|get_byte_integer_evaluator|length_bytea_integer_evaluator|length_bytea_encoding_evaluator|octet_length_bytea_integer_evaluator|position_bytea_evaluator|bit_count_integer_evaluator|bit_length_bit_integer_evaluator|get_bit_integer_evaluator|length_bit_integer_evaluator|octet_length_bit_integer_evaluator|num_nonnulls_integer_evaluator|num_nulls_integer_evaluator|GREATEST_integer_evaluator|LEAST_integer_evaluator|NULLIF_integer_evaluator|date_sub_date_integer_evaluator|family_inet_evaluator|abs_integer_evaluator|at_integer_evaluator|bitwise_and_integral_integer_evaluator|bitwise_lshift_integral_evaluator|bitwise_not_integral_integer_evaluator|bitwise_or_integral_integer_evaluator|div_numeric_integer_evaluator|gcd_integer_evaluator|hash_integer_evaluator|integral_lshift_integer_evaluator|lcm_integer_evaluator|min_scale_integer_evaluator|mod_integer_integer_evaluator|mod_numeric_op_integer_evaluator|mul_integer_evaluator|random_range_integer_evaluator|scale_integer_evaluator|sub_numeric_integer_evaluator|trim_scale_evaluator|unary_plus_integer_evaluator|width_bucket_array_integer_evaluator|width_bucket_func_evaluator|width_bucket_numeric_integer_evaluator|inet_sub_inet_integer_evaluator|masklen_integer_evaluator|ascii_integer_evaluator|ascii_text_integer_evaluator|bit_length_text_integer_evaluator|character_length_integer_evaluator|char_length_integer_evaluator|length_text_integer_evaluator|agg_length_text_integer_evaluator|octet_length_integer_evaluator|octet_length_text_integer_evaluator|position_integer_evaluator|position_text_integer_evaluator|regexp_count_evaluator|regexp_instr_evaluator|strpos_text_evaluator|uuid_extract_version_integer_evaluator;
...
agg_evaluator:integer_AGG_evaluator|bytea_AGG_evaluator|boolean_AGG_evaluator|date_AGG_evaluator|double_AGG_evaluator|text_AGG_evaluator|time_AGG_evaluator|timestamp_AGG_evaluator|bit_AGG_evaluator|inet_AGG_evaluator|character_AGG_evaluator;
...
count_integer_evaluator:"count("_var_bytea")"|"count("_var_time")"|"count("boolean_evaluator_without_agg")"|"count("bit_evaluator_without_agg")"|"count("cidr_evaluator_without_agg")"|"count("bytea_evaluator_without_agg")"|"count("uuid_evaluator_without_agg")"|"count("_var_character")"|"count("_var_cidr")"|"count("macaddr_evaluator_without_agg")"|"count("_var_boolean")"|"count("_var_inet")"|"count("integer_evaluator_without_agg")"|"count("macaddr8_evaluator_without_agg")"|"count("_var_macaddr")"|"count("text_evaluator_without_agg")"|"count("_var_macaddr8")"|"count("_var_double")"|"count("_var_date")"|"count("_var_timestamp")"|"count("_var_text")"|"count("_var_bit")"|"count("character_evaluator_without_agg")"|"count("timestamp_evaluator_without_agg")"|"count("inet_evaluator_without_agg")"|"count("date_evaluator_without_agg")"|"count("_var_integer")"|"count("time_evaluator_without_agg")"|"count("double_evaluator_without_agg")"|"count("_var_uuid")";
...
ISDISTINCTFROM_boolean_evaluator:timestamp_evaluator_without_agg "IS DISTINCT FROM" _var_timestamp|inet_evaluator_without_agg "IS DISTINCT FROM" inet_evaluator_without_agg|date_evaluator_without_agg "IS DISTINCT FROM" date_evaluator_without_agg|_var_date "IS DISTINCT FROM" date_AGG_evaluator|_var_double "IS DISTINCT FROM" double_AGG_evaluator|_var_integer "IS DISTINCT FROM" _var_integer|bit_evaluator_without_agg "IS DISTINCT FROM" bit_AGG_evaluator|_var_macaddr "IS DISTINCT FROM" _var_macaddr|inet_AGG_evaluator "IS DISTINCT FROM" inet_AGG_evaluator|_var_cidr "IS DISTINCT FROM" _var_cidr|timestamp_AGG_evaluator "IS DISTINCT FROM" _var_timestamp|time_evaluator_without_agg "IS DISTINCT FROM" time_evaluator_without_agg|date_evaluator_without_agg "IS DISTINCT FROM" _var_date|inet_evaluator_without_agg "IS DISTINCT FROM" _var_inet|double_AGG_evaluator "IS DISTINCT FROM" _var_double|integer_evaluator_without_agg "IS DISTINCT FROM" integer_evaluator_without_agg|_var_bytea "IS DISTINCT FROM" bytea_evaluator_without_agg|_var_bit "IS DISTINCT FROM" bit_AGG_evaluator|integer_AGG_evaluator "IS DISTINCT FROM" integer_evaluator_without_agg|time_evaluator_without_agg "IS DISTINCT FROM" time_AGG_evaluator|timestamp_evaluator_without_agg "IS DISTINCT FROM" timestamp_AGG_evaluator|bit_evaluator_without_agg "IS DISTINCT FROM" bit_evaluator_without_agg|_var_timestamp "IS DISTINCT FROM" _var_timestamp|character_evaluator_without_agg "IS DISTINCT FROM" character_evaluator_without_agg|_var_character "IS DISTINCT FROM" _var_character|timestamp_AGG_evaluator "IS DISTINCT FROM" timestamp_AGG_evaluator|double_evaluator_without_agg "IS DISTINCT FROM" double_AGG_evaluator|_var_timestamp "IS DISTINCT FROM" timestamp_AGG_evaluator|_var_time "IS DISTINCT FROM" time_AGG_evaluator|character_evaluator_without_agg "IS DISTINCT FROM" character_AGG_evaluator|bit_AGG_evaluator "IS DISTINCT FROM" _var_bit|_var_integer "IS DISTINCT FROM" integer_evaluator_without_agg|double_evaluator_without_agg "IS DISTINCT FROM" _var_double|cidr_evaluator_without_agg "IS DISTINCT FROM" _var_cidr|timestamp_AGG_evaluator "IS DISTINCT FROM" timestamp_evaluator_without_agg|_var_inet "IS DISTINCT FROM" _var_inet|_var_bit "IS DISTINCT FROM" _var_bit|macaddr_evaluator_without_agg "IS DISTINCT FROM" macaddr_evaluator_without_agg|_var_boolean "IS DISTINCT FROM" _var_boolean|_var_macaddr8 "IS DISTINCT FROM" macaddr8_evaluator_without_agg|double_AGG_evaluator "IS DISTINCT FROM" double_AGG_evaluator|integer_evaluator_without_agg "IS DISTINCT FROM" _var_integer|double_AGG_evaluator "IS DISTINCT FROM" double_evaluator_without_agg|time_AGG_evaluator "IS DISTINCT FROM" time_evaluator_without_agg|_var_boolean "IS DISTINCT FROM" boolean_AGG_evaluator|date_AGG_evaluator "IS DISTINCT FROM" date_evaluator_without_agg|boolean_AGG_evaluator "IS DISTINCT FROM" boolean_AGG_evaluator|_var_character "IS DISTINCT FROM" character_evaluator_without_agg|macaddr8_evaluator_without_agg "IS DISTINCT FROM" macaddr8_evaluator_without_agg|_var_macaddr "IS DISTINCT FROM" macaddr_evaluator_without_agg|cidr_evaluator_without_agg "IS DISTINCT FROM" cidr_evaluator_without_agg|bit_AGG_evaluator "IS DISTINCT FROM" bit_evaluator_without_agg|time_evaluator_without_agg "IS DISTINCT FROM" _var_time|_var_time "IS DISTINCT FROM" time_evaluator_without_agg|time_AGG_evaluator "IS DISTINCT FROM" time_AGG_evaluator|double_evaluator_without_agg "IS DISTINCT FROM" double_evaluator_without_agg|date_AGG_evaluator "IS DISTINCT FROM" date_AGG_evaluator|macaddr8_evaluator_without_agg "IS DISTINCT FROM" _var_macaddr8|character_AGG_evaluator "IS DISTINCT FROM" character_evaluator_without_agg|boolean_evaluator_without_agg "IS DISTINCT FROM" boolean_AGG_evaluator|_var_uuid "IS DISTINCT FROM" uuid_evaluator_without_agg|_var_character "IS DISTINCT FROM" character_AGG_evaluator|integer_AGG_evaluator "IS DISTINCT FROM" integer_AGG_evaluator|_var_timestamp "IS DISTINCT FROM" timestamp_evaluator_without_agg|date_evaluator_without_agg "IS DISTINCT FROM" date_AGG_evaluator|boolean_AGG_evaluator "IS DISTINCT FROM" _var_boolean|macaddr_evaluator_without_agg "IS DISTINCT FROM" _var_macaddr|bit_evaluator_without_agg "IS DISTINCT FROM" _var_bit|_var_macaddr8 "IS DISTINCT FROM" _var_macaddr8|time_AGG_evaluator "IS DISTINCT FROM" _var_time|_var_date "IS DISTINCT FROM" date_evaluator_without_agg|_var_date "IS DISTINCT FROM" _var_date|character_AGG_evaluator "IS DISTINCT FROM" character_AGG_evaluator|_var_inet "IS DISTINCT FROM" inet_evaluator_without_agg|character_evaluator_without_agg "IS DISTINCT FROM" _var_character|_var_double "IS DISTINCT FROM" double_evaluator_without_agg|_var_integer "IS DISTINCT FROM" integer_AGG_evaluator|_var_time "IS DISTINCT FROM" _var_time|character_AGG_evaluator "IS DISTINCT FROM" _var_character|timestamp_evaluator_without_agg "IS DISTINCT FROM" timestamp_evaluator_without_agg|inet_AGG_evaluator "IS DISTINCT FROM" _var_inet|_var_double "IS DISTINCT FROM" _var_double|integer_AGG_evaluator "IS DISTINCT FROM" _var_integer|_var_bit "IS DISTINCT FROM" bit_evaluator_without_agg|bit_AGG_evaluator "IS DISTINCT FROM" bit_AGG_evaluator|_var_uuid "IS DISTINCT FROM" _var_uuid|date_AGG_evaluator "IS DISTINCT FROM" _var_date;
ISNOTDISTINCTFROM_boolean_evaluator:_var_timestamp "IS NOT DISTINCT FROM" timestamp_evaluator_without_agg|_var_time "IS NOT DISTINCT FROM" _var_time|bit_AGG_evaluator "IS NOT DISTINCT FROM" _var_bit|bytea_evaluator_without_agg "IS NOT DISTINCT FROM" bytea_evaluator_without_agg|_var_time "IS NOT DISTINCT FROM" time_AGG_evaluator|bit_AGG_evaluator "IS NOT DISTINCT FROM" bit_AGG_evaluator|integer_evaluator_without_agg "IS NOT DISTINCT FROM" _var_integer|integer_AGG_evaluator "IS NOT DISTINCT FROM" _var_integer|time_evaluator_without_agg "IS NOT DISTINCT FROM" _var_time|_var_timestamp "IS NOT DISTINCT FROM" _var_timestamp|date_AGG_evaluator "IS NOT DISTINCT FROM" date_evaluator_without_agg|date_AGG_evaluator "IS NOT DISTINCT FROM" _var_date|timestamp_evaluator_without_agg "IS NOT DISTINCT FROM" timestamp_evaluator_without_agg|_var_cidr "IS NOT DISTINCT FROM" _var_cidr|_var_integer "IS NOT DISTINCT FROM" integer_AGG_evaluator|_var_bit "IS NOT DISTINCT FROM" _var_bit|bit_evaluator_without_agg "IS NOT DISTINCT FROM" _var_bit|character_AGG_evaluator "IS NOT DISTINCT FROM" _var_character|bit_evaluator_without_agg "IS NOT DISTINCT FROM" bit_AGG_evaluator|date_evaluator_without_agg "IS NOT DISTINCT FROM" date_evaluator_without_agg|macaddr8_evaluator_without_agg "IS NOT DISTINCT FROM" _var_macaddr8|inet_evaluator_without_agg "IS NOT DISTINCT FROM" inet_AGG_evaluator|time_AGG_evaluator "IS NOT DISTINCT FROM" time_evaluator_without_agg|time_AGG_evaluator "IS NOT DISTINCT FROM" time_AGG_evaluator|_var_timestamp "IS NOT DISTINCT FROM" timestamp_AGG_evaluator|_var_boolean "IS NOT DISTINCT FROM" boolean_AGG_evaluator|_var_macaddr "IS NOT DISTINCT FROM" _var_macaddr|_var_bit "IS NOT DISTINCT FROM" bit_AGG_evaluator|date_AGG_evaluator "IS NOT DISTINCT FROM" date_AGG_evaluator|timestamp_AGG_evaluator "IS NOT DISTINCT FROM" timestamp_AGG_evaluator|integer_evaluator_without_agg "IS NOT DISTINCT FROM" integer_AGG_evaluator|double_evaluator_without_agg "IS NOT DISTINCT FROM" _var_double|character_evaluator_without_agg "IS NOT DISTINCT FROM" character_AGG_evaluator|bit_evaluator_without_agg "IS NOT DISTINCT FROM" bit_evaluator_without_agg|timestamp_AGG_evaluator "IS NOT DISTINCT FROM" _var_timestamp|integer_AGG_evaluator "IS NOT DISTINCT FROM" integer_AGG_evaluator|_var_inet "IS NOT DISTINCT FROM" inet_evaluator_without_agg|macaddr8_evaluator_without_agg "IS NOT DISTINCT FROM" macaddr8_evaluator_without_agg|character_AGG_evaluator "IS NOT DISTINCT FROM" character_evaluator_without_agg|double_evaluator_without_agg "IS NOT DISTINCT FROM" double_AGG_evaluator|_var_time "IS NOT DISTINCT FROM" time_evaluator_without_agg|bit_AGG_evaluator "IS NOT DISTINCT FROM" bit_evaluator_without_agg|inet_AGG_evaluator "IS NOT DISTINCT FROM" inet_AGG_evaluator|_var_double "IS NOT DISTINCT FROM" double_AGG_evaluator|inet_evaluator_without_agg "IS NOT DISTINCT FROM" _var_inet|_var_inet "IS NOT DISTINCT FROM" _var_inet|double_AGG_evaluator "IS NOT DISTINCT FROM" double_AGG_evaluator|date_evaluator_without_agg "IS NOT DISTINCT FROM" _var_date|boolean_AGG_evaluator "IS NOT DISTINCT FROM" boolean_AGG_evaluator|_var_macaddr8 "IS NOT DISTINCT FROM" macaddr8_evaluator_without_agg|time_evaluator_without_agg "IS NOT DISTINCT FROM" time_AGG_evaluator|macaddr_evaluator_without_agg "IS NOT DISTINCT FROM" _var_macaddr|timestamp_AGG_evaluator "IS NOT DISTINCT FROM" timestamp_evaluator_without_agg|integer_evaluator_without_agg "IS NOT DISTINCT FROM" integer_evaluator_without_agg|timestamp_evaluator_without_agg "IS NOT DISTINCT FROM" _var_timestamp|character_evaluator_without_agg "IS NOT DISTINCT FROM" character_evaluator_without_agg|double_evaluator_without_agg "IS NOT DISTINCT FROM" double_evaluator_without_agg|double_AGG_evaluator "IS NOT DISTINCT FROM" _var_double|_var_uuid "IS NOT DISTINCT FROM" uuid_evaluator_without_agg|_var_double "IS NOT DISTINCT FROM" _var_double|_var_double "IS NOT DISTINCT FROM" double_evaluator_without_agg|boolean_AGG_evaluator "IS NOT DISTINCT FROM" _var_boolean|_var_bit "IS NOT DISTINCT FROM" bit_evaluator_without_agg|_var_date "IS NOT DISTINCT FROM" date_AGG_evaluator|_var_integer "IS NOT DISTINCT FROM" integer_evaluator_without_agg|_var_date "IS NOT DISTINCT FROM" date_evaluator_without_agg|_var_date "IS NOT DISTINCT FROM" _var_date|time_evaluator_without_agg "IS NOT DISTINCT FROM" time_evaluator_without_agg|_var_boolean "IS NOT DISTINCT FROM" _var_boolean|timestamp_evaluator_without_agg "IS NOT DISTINCT FROM" timestamp_AGG_evaluator|double_AGG_evaluator "IS NOT DISTINCT FROM" double_evaluator_without_agg|character_evaluator_without_agg "IS NOT DISTINCT FROM" _var_character|time_AGG_evaluator "IS NOT DISTINCT FROM" _var_time|_var_character "IS NOT DISTINCT FROM" _var_character|_var_macaddr "IS NOT DISTINCT FROM" macaddr_evaluator_without_agg|_var_integer "IS NOT DISTINCT FROM" _var_integer|_var_character "IS NOT DISTINCT FROM" character_evaluator_without_agg;
...
GREATEST_bit_evaluator:"GREATEST("bit_evaluator_without_agg "," bit_AGG_evaluator("," bit_AGG_evaluator)*")"|"GREATEST("_var_bit "," _var_bit("," _var_bit)*")"|"GREATEST("bit_AGG_evaluator "," bit_evaluator_without_agg("," bit_evaluator_without_agg)*")"|"GREATEST("_var_bit "," bit_evaluator_without_agg("," bit_evaluator_without_agg)*")"|"GREATEST("bit_evaluator_without_agg "," _var_bit("," _var_bit)*")";
...
LEAST_bit_evaluator:"LEAST("bit_evaluator_without_agg "," bit_AGG_evaluator("," bit_AGG_evaluator)*")"|"LEAST("bit_AGG_evaluator "," bit_AGG_evaluator("," bit_AGG_evaluator)*")"|"LEAST("_var_bit "," bit_evaluator_without_agg("," bit_evaluator_without_agg)*")"|"LEAST("_var_bit "," _var_bit("," _var_bit)*")"|"LEAST("bit_evaluator_without_agg "," _var_bit("," _var_bit)*")"|"LEAST("bit_evaluator_without_agg "," bit_evaluator_without_agg("," bit_evaluator_without_agg)*")";
...
NULLIF_bit_evaluator:"NULLIF("_var_bit "," _var_bit")"|"NULLIF("bit_evaluator_without_agg "," bit_AGG_evaluator")"|"NULLIF("bit_evaluator_without_agg "," _var_bit")"|"NULLIF("bit_AGG_evaluator "," bit_evaluator_without_agg")"|"NULLIF("_var_bit "," bit_AGG_evaluator")"|"NULLIF("bit_AGG_evaluator "," _var_bit")"|"NULLIF("_var_bit "," bit_evaluator_without_agg")"|"NULLIF("bit_AGG_evaluator "," bit_AGG_evaluator")";
NULLIF_macaddr8_evaluator:"NULLIF("macaddr8_evaluator_without_agg "," _var_macaddr8")"|"NULLIF("_var_macaddr8 "," _var_macaddr8")"|"NULLIF("_var_macaddr8 "," macaddr8_evaluator_without_agg")";
...
to_char_text_evaluator:"to_char("_var_integer "," "'999D99S'"")"|"to_char("double_evaluator_without_agg "," "'999D99S'"")"|"to_char("integer_evaluator_without_agg "," "'999D99S'"")"|"to_char("integer_evaluator_without_agg "," "'999D9'"")"|"to_char("_var_integer "," "'999'"")"|"to_char("double_evaluator_without_agg "," "'999'"")"|"to_char("integer_AGG_evaluator "," "'999D99S'"")"|"to_char("_var_double "," "'999D99S'"")"|"to_char("double_AGG_evaluator "," "'999'"")"|"to_char("double_AGG_evaluator "," "'999D99S'"")"|"to_char("integer_evaluator_without_agg "," "'999'"")"|"to_char("_var_double "," "'999'"")"|"to_char("_var_integer "," "'999D9'"")"|"to_char("_var_double "," "'999D9'"")"|"to_char("double_evaluator_without_agg "," "'999D9'"")"|"to_char("integer_AGG_evaluator "," "'999D9'"")";
...
date_trunc_timestamp_evaluator:"date_trunc(""'microsecond'" "," _var_timestamp")"|"date_trunc(""'hour'" "," timestamp_AGG_evaluator")"|"date_trunc(""'year'" "," _var_timestamp")"|"date_trunc(""'minute'" "," timestamp_evaluator_without_agg")"|"date_trunc(""'millisecond'" "," _var_timestamp")"|"date_trunc(""'day'" "," _var_timestamp")"|"date_trunc(""'quarter'" "," timestamp_AGG_evaluator")"|"date_trunc(""'week'" "," timestamp_AGG_evaluator")"|"date_trunc(""'year'" "," timestamp_evaluator_without_agg")"|"date_trunc(""'century'" "," _var_timestamp")"|"date_trunc(""'second'" "," _var_timestamp")"|"date_trunc(""'minute'" "," timestamp_AGG_evaluator")"|"date_trunc(""'year'" "," timestamp_AGG_evaluator")"|"date_trunc(""'millisecond'" "," timestamp_AGG_evaluator")"|"date_trunc(""'millennium'" "," timestamp_evaluator_without_agg")"|"date_trunc(""'second'" "," timestamp_evaluator_without_agg")"|"date_trunc(""'microsecond'" "," timestamp_evaluator_without_agg")"|"date_trunc(""'quarter'" "," _var_timestamp")"|"date_trunc(""'day'" "," timestamp_AGG_evaluator")"|"date_trunc(""'minute'" "," _var_timestamp")"|"date_trunc(""'month'" "," timestamp_AGG_evaluator")"|"date_trunc(""'week'" "," timestamp_evaluator_without_agg")"|"date_trunc(""'second'" "," timestamp_AGG_evaluator")"|"date_trunc(""'millisecond'" "," timestamp_evaluator_without_agg")"|"date_trunc(""'millennium'" "," timestamp_AGG_evaluator")"|"date_trunc(""'millennium'" "," _var_timestamp")"|"date_trunc(""'decade'" "," _var_timestamp")"|"date_trunc(""'century'" "," timestamp_AGG_evaluator")"|"date_trunc(""'decade'" "," timestamp_AGG_evaluator")"|"date_trunc(""'hour'" "," _var_timestamp")"|"date_trunc(""'microsecond'" "," timestamp_AGG_evaluator")";
...
btrim_text_evaluator:"btrim("character_evaluator_without_agg "," "''"")"|"btrim("_var_character "," "' '"")"|"btrim("_var_character "," "''"")"|"btrim("character_AGG_evaluator "," "' '"")"|"btrim("character_AGG_evaluator "," "''"")"|"btrim("character_AGG_evaluator")"|"btrim("character_evaluator_without_agg "," "'xyz'"")"|"btrim("character_evaluator_without_agg "," "' '"")"|"btrim("_var_character "," "'xyz'"")"|"btrim("character_AGG_evaluator "," "'xyz'"")"|"btrim("character_evaluator_without_agg")"|"btrim("_var_character")";
...
concat_text_evaluator:"concat("_var_bit("," _var_bit)*")"|"concat("_var_text("," _var_text)*")"|"concat("double_AGG_evaluator("," double_AGG_evaluator)*")"|"concat("integer_evaluator_without_agg("," integer_evaluator_without_agg)*")"|"concat("inet_AGG_evaluator("," inet_AGG_evaluator)*")"|"concat("_var_timestamp("," _var_timestamp)*")"|"concat("character_evaluator_without_agg("," character_evaluator_without_agg)*")"|"concat("date_evaluator_without_agg("," date_evaluator_without_agg)*")"|"concat("integer_AGG_evaluator("," integer_AGG_evaluator)*")"|"concat("_var_double("," _var_double)*")"|"concat("macaddr8_evaluator_without_agg("," macaddr8_evaluator_without_agg)*")"|"concat("_var_character("," _var_character)*")"|"concat("text_evaluator_without_agg("," text_evaluator_without_agg)*")"|"concat("_var_inet("," _var_inet)*")"|"concat("time_AGG_evaluator("," time_AGG_evaluator)*")"|"concat("timestamp_AGG_evaluator("," timestamp_AGG_evaluator)*")"|"concat("_var_cidr("," _var_cidr)*")"|"concat("uuid_evaluator_without_agg("," uuid_evaluator_without_agg)*")"|"concat("bit_AGG_evaluator("," bit_AGG_evaluator)*")"|"concat("text_AGG_evaluator("," text_AGG_evaluator)*")"|"concat("cidr_evaluator_without_agg("," cidr_evaluator_without_agg)*")"|"concat("_var_bytea("," _var_bytea)*")"|"concat("_var_date("," _var_date)*")"|"concat("_var_boolean("," _var_boolean)*")"|"concat("_var_time("," _var_time)*")";
concat_ws_text_evaluator:"concat_ws("_var_character "," _var_bit ("," _var_bit)*")";
convert_from_text_evaluator:"convert_from(" "'Hello'::bytea" "," "'UTF8'" ")";
...
oror_text_evaluator:_var_text "||" character_evaluator_without_agg|text_evaluator_without_agg "||" boolean_AGG_evaluator|text_evaluator_without_agg "||" timestamp_AGG_evaluator|_var_text "||" time_AGG_evaluator|character_evaluator_without_agg "||" text_evaluator_without_agg|character_evaluator_without_agg "||" text_AGG_evaluator|character_AGG_evaluator "||" _var_text|character_AGG_evaluator "||" text_AGG_evaluator|text_evaluator_without_agg "||" text_AGG_evaluator|_var_text "||" bit_AGG_evaluator|_var_text "||" date_AGG_evaluator|text_evaluator_without_agg "||" character_AGG_evaluator|_var_text "||" boolean_AGG_evaluator|_var_text "||" double_AGG_evaluator|text_evaluator_without_agg "||" date_AGG_evaluator|text_AGG_evaluator "||" character_AGG_evaluator|text_evaluator_without_agg "||" bit_AGG_evaluator|text_evaluator_without_agg "||" character_evaluator_without_agg|_var_text "||" inet_AGG_evaluator|_var_text "||" text_AGG_evaluator|text_AGG_evaluator "||" character_evaluator_without_agg|character_evaluator_without_agg "||" _var_text|character_AGG_evaluator "||" text_evaluator_without_agg|_var_text "||" integer_AGG_evaluator|text_evaluator_without_agg "||" time_AGG_evaluator|_var_text "||" timestamp_AGG_evaluator|_var_text "||" character_AGG_evaluator|text_evaluator_without_agg "||" double_AGG_evaluator|text_evaluator_without_agg "||" integer_AGG_evaluator;
